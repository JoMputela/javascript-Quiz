...
let questions = [   // Array of objects for quiz questions & answers
    ['Africa is a continent (a very large mass of land) which is made up of many different countries. How many countries make up the continent of Africa?', ' 24', ' 54', ' 84', '57', 'b'],

    ['What percentage of all the land on the planet Earth does Africa cover?',
' 10%',     ' 20%',     ' 30%', ' 84', 'b'
],
    ['What are the origins of the name Africa? The name has its origins in a small country in the North of Africa (Tunisia) and it means:',
' sunny place',     ' enormous place',' black place',    ' dangerous place', 'a'],

    ['In 1950, about 221 million people lived in Africa. How many people live in Africa today?', ' 500 million people',     
' 750 million people ',    
' more than 1000 million billion people',' 84000 people', 'c'],
